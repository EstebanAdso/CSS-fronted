    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="pt-20 pb-0 px-4 sm:px-6 lg:px-8 max-w-[1624px] mx-auto border-b border-gray-100">
        <nav aria-label="breadcrumb" className="flex items-center gap-2 text-xs text-gray-400 py-3 flex-wrap">
          ...
          <span>/</span>
          <Link href="/catalogo" className="hover:text-[#8c52ff] transition-colors">Catálogo</Link>
          <span>/</span>
          <Link href={urlCat} className="hover:text-[#8c52ff] transition-colors">
            {producto.categoria.nombre}
          </Link>
          <span>/</span>
      ...
      <section className="px-4 sm:px-6 lg:px-8 py-10 max-w-[1624px] mx-auto">
        <div className="grid md:grid-cols-2 gap-10 items-start">
          ...
          <div className="flex flex-col gap-5">
            <Link href={urlCat}
              className="inline-flex w-fit items-center gap-1 text-xs font-bold uppercase tracking-widest text-[#8c52ff] hover:text-[#6a00bb] transition-colors">
              ← {producto.categoria.nombre}
            </Link>
            ...
            <div className="flex items-end gap-2">
              <span className="text-3xl font-black" style={{ color: "rgb(17,17,17)" }}>
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-2">
              <a href={`https://wa.me/573242264795?text=${msgWsp}`}
                target="_blank" rel="noopener noreferrer"
                className="flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl font-bold flex-1 bg-[#8c52ff] hover:bg-[#6a00bb] text-white transition-colors">
              ...
              <a href="tel:+573242264795"
                className="flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl font-bold border border-gray-200 text-gray-700 hover:border-[#8c52ff]/40 hover:text-[#8c52ff] transition-colors">
