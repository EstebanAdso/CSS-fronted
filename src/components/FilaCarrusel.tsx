        ...
        {productos.map((p) => {
          ...
          return (
            <Link
              key={p.id}
              href={url}
              className="group shrink-0 w-[calc(50%-6px)] sm:w-[260px] flex flex-col rounded-xl border border-gray-200 bg-white hover:border-gray-400 hover:shadow-md transition-all duration-200 overflow-hidden"
