...
const contactos = [
  ...
  },
  {
    ...
    label: "compuservicessoft@gmail.com",
      ...
      <div className="container-site">
              ...
              {contactos.map((c) => (
                <li key={c.label}>
                  <a
                    ...
                    className="flex items-center gap-2.5 text-sm text-gray-300 hover:text-white transition-colors duration-200 group justify-center sm:justify-start"
                  >
                    <span className="text-gray-400 group-hover:text-white transition-colors duration-200 shrink-0">
                      {c.icon}
                    </span>
        ...
        <div className="border-t border-white/10 pt-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-xs text-gray-400 text-center">
            © {currentYear} CompuServicesSoft — Pasto, Nariño, Colombia. Todos los derechos reservados.
          </p>
          <a
            href="https://wa.me/573187967822?text=Hola%20vine%20de%20la%20p%C3%A1gina%20web%20CompuServicesSoft"
            target="_blank"
            rel="noopener noreferrer"
            className="text-xs text-gray-400 hover:text-white transition-colors duration-200"
          >
            ¿Te interesa una página así? Escríbenos
          </a>
        </div>
      </div>
    </footer>
